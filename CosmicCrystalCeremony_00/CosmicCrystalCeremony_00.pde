...
void setup() {
  ...
  controlGui.addSlider("crystalSidesUVs").setRange(0.6, 1).setPosition(20, 20).setDefaultValue(1).setLabel("CRYSTAL SIDE VERTEX UVs");
  controlGui.addSlider("layersOpacity").setRange(0,1).setPosition(20,40).setDefaultValue(1).setLabel("SURFACES ALPHA");
